...
export default function NewsPanel() {
  ...
  return (
    <div className="flex flex-col h-full px-4 py-4 rounded bg-base shadow-xl">
      ...
      <div
        ref={scrollRef}
        className="flex-1 overflow-y-auto flex flex-col justify-end space-y-4 pr-2 custom-scrollbar"
      >
        {loading ? (
          ...
          [...tweets].reverse().map((news, idx) => {
            const timestamp = new Date(news.timestamp + "Z");
            ...
            return (
              <div
                key={idx}
                className="bg-panel p-3 rounded shadow text-white border border-primary/20"
              >
